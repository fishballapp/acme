...
`@fishball/acme` is a zero-dependency, minimalistic, opiniated Automatic
...
### 0x00: Add @fishball/acme

```bash
$ deno add @fishball/acme
```
...
```ts
import { ACME_DIRECTORY_URLS, AcmeClient } from "@fishball/acme";
